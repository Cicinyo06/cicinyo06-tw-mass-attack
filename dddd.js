...
// You need to integrate handleSubmit() to generate `plans`, `destinationVillage`, and `landingTime`, then attach events:
...
// === Existing helpers (getCurrentDateTime, fetchUnitInfo, xml2json, etc.) burada aynı şekilde devam ediyor ===
